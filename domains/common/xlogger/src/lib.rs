...
impl Basic for XLogger {}

impl LogDomain for XLogger {
...
impl Log for SimpleLogger {
    ...
    fn log(&self, record: &Record) {
        ...
        let color = match record.level() {
            ...
            log::Level::Warn => 33,  // BrightYellow
            log::Level::Info => 32,  // Blue
            log::Level::Debug => 35, // Green
            log::Level::Trace => 36, // BrightBlack
        };
        println!(
            "\u{1B}[1;{}m[{:>1}] {}\u{1B}[0m",
            color,
