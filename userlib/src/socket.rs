...
use crate::syscall::{
    ...
    sys_recvfrom, sys_sendto, sys_shutdown, 
};
...
pub fn socket_pair(domain: Domain, socket_type: SocketType, protocol: usize, sv: *const usize ) -> isize {
...
pub fn sendto(
    ...
    sys_sendto(socket, message, length, flags, dest_addr as *const usize, dest_len)
}
...
pub fn recvfrom(
    ...
    sys_recvfrom(socket, buffer, length, flags, src_addr as *mut usize, address_len)
}
...
pub fn recv(
    ...
    sys_recvfrom(socket, buffer, length, flags, 0 as *mut usize, 0 as *mut usize)
}
