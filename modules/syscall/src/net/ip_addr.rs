...
///
/// ```
/// use crate::syscall::net::Ipv4Addr;
///
...
///
/// ```
/// use crate::syscall::net::Ipv6Addr;
///
...
impl IpAddr {
    ...
    ///
    /// ```
    /// use crate::syscall::net::{IpAddr, Ipv4Addr, Ipv6Addr};
    ///
...
impl Ipv4Addr {
    ...
    ///
    /// ```
    /// use crate::syscall::net::{Ipv4Addr, Ipv6Addr};
    ///
    /// assert_eq!(
...
impl From<Ipv4Addr> for IpAddr {
    ...
    ///
    /// ```
    /// use crate::syscall::net::{IpAddr, Ipv4Addr};
    ///
    /// let addr = Ipv4Addr::new(127, 0, 0, 1);
    ///
    /// assert_eq!(
...
impl From<Ipv6Addr> for IpAddr {
    ...
    ///
    /// ```
    /// use crate::syscall::net::{IpAddr, Ipv6Addr};
    ///
...
impl PartialEq<Ipv6Addr> for IpAddr {
    fn eq(&self, other: &Ipv6Addr) -> bool {
        match self {
            IpAddr::V4(_) => false,
            IpAddr::V6(v6) => {
                let order = v6.partial_cmp(other);
            }
        }
    }
}
