...
///
/// ```
/// use crate::syscall::net::{IpAddr, Ipv4Addr, SocketAddr};
///
...
///
/// ```
/// use crate::syscall::net::{Ipv4Addr, SocketAddrV4};
///
...
///
/// ```
/// use crate::syscall::net::{Ipv6Addr, SocketAddrV6};
///
...
impl SocketAddr {
    ...
    ///
    /// ```
    /// use crate::syscall::net::{IpAddr, Ipv6Addr, SocketAddr};
    ///
...
impl SocketAddrV4 {
    ...
    ///
    /// ```
    /// use crate::syscall::net::{SocketAddrV4, Ipv4Addr};
    ///
    /// let socket = SocketAddrV4::new(Ipv4Addr::new(127, 0, 0, 1), 8080);
    /// ```
    #[must_use]
...
impl SocketAddrV6 {
    ...
    ///
    /// ```
    /// use crate::syscall::net::{SocketAddrV6, Ipv6Addr};
    ///
